...
//qna le constant value magexa so, maile final use garnu prne hunca.

final double killmouse=0.0012;
final double weight=35.0;

final double wtofdieter=90.0;
final double desiredwt=75.0;

 final double sweetner= 0.001;
double death= (killmouse/weight)*(wtofdieter/desiredwt);

 System.out.println("the amount of sweetner required"+ death);
}}
